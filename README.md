...
Usage: perl L1_bar_wrapperV3.pl<read1.fq> <read2.fq> <barcode> <aligner> <TF_to_scan>
 
For <aligner>: options can be combined without spaces in between (i.e. 12, 123 or 1234); Genome database is hg19.  
